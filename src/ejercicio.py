from lectura_archivo import leer_informacion_alumnos, guardar_informacion_alumnos, agregar_registro
...
def main():
    alumnos = leer_informacion_alumnos(RUTA_ALUMNOS)
    opcion = ""
    while opcion != SALIR:
        print("1. Alta\n2. Consulta\n3. Listar\n4. Salir")
        ...
        if opcion == ALTA_ALUMNO:
            ...
            agregar_registro(alumno, RUTA_REGISTRO)
    ...
    guardar_informacion_alumnos(alumnos, RUTA_ALUMNOS)
